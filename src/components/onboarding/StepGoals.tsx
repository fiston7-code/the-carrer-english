  ...
  return (
    <div className="flex flex-col max-w-sm w-full">
      ...
      <div className="flex gap-2 mb-10">
        {[0, 1, 2, 3, 4].map((i) => (
          <div key={i} className="h-1 w-10 rounded-full bg-gold" />
        ))}
      </div>
      ...
      <p className="text-steel text-sm text-center mb-6">Select all that apply</p>
            ...
            >
              <div className="flex items-center gap-4">
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center
                  ${selected ? 'bg-gold' : 'bg-muted'}`}>
                  <Icon
                    size={18}
                    className={selected ? 'text-primary-foreground' : 'text-steel'}
                  />
                </div>
      ...
      <button
        ...
        className="w-full bg-gold hover:bg-gold/90 disabled:opacity-40 disabled:cursor-not-allowed text-primary-foreground font-semibold py-4 rounded-xl flex items-center justify-center gap-2 transition"
      >
        {loading ? 'Loading...' : (
