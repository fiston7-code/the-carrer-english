...
//     muted: "bg-red-500/20 text-red-400 hover:bg-red-500/30",
//     active: "bg-green-500/20 text-green-400 hover:bg-green-500/30",
//     neutral: "bg-gray-800 text-gray-300 hover:bg-gray-700",
//     danger: "bg-red-500/20 text-red-400 hover:bg-red-500/30",
//   };
...
//                     transition-colors ${styles[variant]}`}
//       >
//         {icon}
//       </button>
...
//   return (
//     <div className="px-6 py-5 border-t border-gray-800 bg-[#0f0f0f]">
//       <div className="flex items-center justify-center gap-8">
//         {canSpeak && (
//           <ControlButton
//             onClick={onMuteToggle}
...
//             onClick={onHandRaise}
//             icon={<Hand size={22} />}
//             label={isHandRaised ? "Baisser" : "Lever"}
//             variant={isHandRaised ? "active" : "neutral"}
//           />
//         )}
